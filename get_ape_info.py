...
api_url = "https://mainnet.infura.io/v3/8a55488f237348c18ee626862b2b3179"  # YOU WILL NEED TO PROVIDE THE URL OF AN ETHEREUM NODE
...
def get_ape_info(ape_id):
    ...
    try:
        ...
        print(f"Error retrieving data for Ape ID {ape_id}: {e}")
